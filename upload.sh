...
upload() {
  ...
  # s3cmd sync $1 --add-header "Content-Encoding: gzip" --add-header "Cache-Control: no-cache, no-store, must-revalidate" --add-header "Pragma: no-cache" --add-header "Expires: 0" --mime-type="text/html" --acl-public out/index.html s3://www.voxelmars.com/
